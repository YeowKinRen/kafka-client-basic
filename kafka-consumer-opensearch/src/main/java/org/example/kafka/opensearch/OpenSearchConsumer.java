...
public class OpenSearchConsumer {
    ...
    public static RestHighLevelClient createOpenSearchClient(){
        ...
        // extract login informaction if it exists
    ...
    private static KafkaConsumer<String, String> createKafkaConsumer() {
        ...
        properties.setProperty(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "latest"); //"none if no prev offset is found don't start/earliest read from the very beginning/latest read now"
